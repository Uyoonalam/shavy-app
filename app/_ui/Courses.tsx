...
export default function CoursesUI({ theme, onBack, onPayment }: CoursesUIProps) {
  ...
  const courses = [
    ...
    { id: 3, level: "Intermediate", price: "$20", priceValue: 20, title: "Advanced Negotiation", shortDesc: "Master salary negotiation.", fullDesc: "Learn proven negotiation tactics for job offers.", duration: "3 hours", instructor: "David Kim", qualification: "Negotiation Expert", icon: "⭐" },
    { id: 4, level: "Intermediate", price: "$20", priceValue: 20, title: "Personal Branding", shortDesc: "Build your brand and stand out.", fullDesc: "Develop your unique value proposition.", duration: "2.5 hours", instructor: "Jessica Wu", qualification: "Brand Strategist", icon: "⭐" },
    { id: 5, level: "Intermediate", price: "$20", priceValue: 20, title: "Strategic Networking", shortDesc: "Learn proven networking strategies.", fullDesc: "Build meaningful professional relationships.", duration: "2 hours", instructor: "Michael Brooks", qualification: "Networking Coach", icon: "⭐" },
    { id: 6, level: "Advanced", price: "$40", priceValue: 40, title: "Leadership Masterclass", shortDesc: "Develop executive presence.", fullDesc: "Emotional intelligence and delegation strategies.", duration: "5 hours", instructor: "Dr. Angela Hayes", qualification: "Leadership Psychologist", icon: "👑" },
